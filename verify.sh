...
./target/release/bz2zstd --input test_data.bin.bz2 --output test_output_pbzip2.bin.zst
...
./target/release/bz2zstd --input concat.bz2 --output test_output_concat.bin.zst
